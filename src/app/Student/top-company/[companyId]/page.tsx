...
import { useTopCompanyHandler, type TopCompanyDetail } from "@/hooks/companyapihandler/useTopCompanyHandler";
    ...
    <div className="pt-14 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
      ...
      <div className="space-y-2 w-full">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed line-clamp-5">
          {company?.corporate ||company.description|| "Add company description here..."}
        </p>
      </div>
    </div>
  </div>
